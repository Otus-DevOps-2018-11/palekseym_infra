...
## Задание основное. Тестирование роли
 ...
 - Плейбуки packer_app.yml и packer_db.yml переписаны на использование ролей
 - Шаблоны пакера app.json и db.json отредактированны для использования ролей ansible
